...
| 2026-04-23 | Config Versioning | MigrationRegistry._find_next_version always returns None — no chain migration support | Low | Open | Only direct V1_2→V1_3 is registered; multi-step chains not yet needed |
