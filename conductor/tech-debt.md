...
| 2026-04-23 | Config Versioning | MigrationRegistry._find_next_version always returns None — no chain migration support | Low | Resolved | Multi-step chains not yet needed; direct V1_2→V1_3 is sufficient per spec |
